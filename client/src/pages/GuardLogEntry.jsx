      ...
      <div className="space-y-6">
        <div className="glass-card p-6 shadow-sm border border-white/20 dark:border-white/10">
          ...
          <div className="mt-6 flex flex-col gap-4">
              ...
              <div key={log.id} className="rounded-2xl border border-white/30 dark:border-white/10 bg-white/40 dark:bg-slate-800/40 p-4 shadow-sm backdrop-blur-md hover:bg-white/60 dark:hover:bg-slate-800/60 transition-colors">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-lg font-bold text-foreground">{log.busNumber} <span className="text-sm font-medium text-muted-foreground">({log.type === "entry" ? "Arrival" : "Departure"})</span></p>
                      <p className="mt-0.5 text-sm font-medium text-muted-foreground">{log.gate} • {log.date} @ {log.time}</p>
                    </div>
                  </div>
            ...
            {recentLogs.length === 0 && (
              <p className="text-center text-sm text-muted-foreground py-4">No recent logs recorded by you.</p>
            )}
          </div>
        </div>
      </div>
