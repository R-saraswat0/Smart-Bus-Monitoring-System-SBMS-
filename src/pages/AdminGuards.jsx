    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
          {guards.map((guard) => (
            <div
              key={guard.id}
              className="glass-card interactive-card p-6 border border-white/20 dark:border-white/10 animate-in fade-in duration-300"
            >
        ...
        {guards.length === 0 && (
          <div className="col-span-2 p-12 text-center glass-panel">
            ...
            <p className="mt-2 text-slate-500">Add a guard to manage shift coverage.</p>
          </div>
        )}
      </div>
    </div>
