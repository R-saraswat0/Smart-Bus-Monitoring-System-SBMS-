  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 className="text-4xl font-bold bg-gradient-to-r from-slate-950 via-teal-800 to-slate-900 bg-clip-text text-transparent dark:from-white dark:via-teal-300 dark:to-slate-300">Dashboard</h2>
          <p className="mt-3 text-lg text-slate-600 dark:text-slate-400 max-w-2xl">Real-time fleet operations with live capacity alerts, delay tracking, and comprehensive analytics.</p>
        </div>
        <div className="glass-panel px-6 py-3 text-sm font-semibold text-slate-800 dark:text-slate-200 shadow-lg flex items-center gap-6 backdrop-blur-xl border border-white/30 dark:border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs uppercase tracking-wider text-slate-500">Routes Done</p>
              <span className="text-2xl font-bold text-slate-900 dark:text-white block">148</span>
            </div>
          </div>
          <div className="w-px h-12 bg-gradient-to-b from-slate-300 to-transparent dark:from-slate-600"></div>
          <div className="flex items-center gap-3">
            <div className="relative">
            ...
            <div>
              <p className="text-xs uppercase tracking-wider text-slate-500">Tracked Logs</p>
              <span className="text-2xl font-bold text-slate-900 dark:text-white block">{logs.length}</span>
            </div>
          </div>
        </div>
      </div>
